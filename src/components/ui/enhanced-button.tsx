...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-smooth focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default: "bg-primary text-primary-foreground shadow-card hover:shadow-hover",
        ...
        // Academic-themed variants
        academic: "bg-gradient-primary text-primary-foreground shadow-glow hover:shadow-hover transform hover:scale-105 transition-bounce",
        success: "bg-accent text-accent-foreground shadow-card hover:shadow-hover",
        hero: "bg-gradient-hero text-white shadow-glow hover:shadow-hover transform hover:scale-105 transition-bounce text-base font-semibold",
      },
      size: {
